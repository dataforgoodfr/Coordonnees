...
export type ProjectionDefinitionSpecification =
  | string
  | ProjectionDefinitionT
  | PropertyValueSpecification<ProjectionDefinitionT>;
...
export type VariableAnchorOffsetCollectionSpecification = Array<
...
export type ExpressionSpecification =
  ...
  | [
    ...
    ] // alternating number and number | ColorSpecification | ExpressionSpecification | ProjectionDefinitionSpecification
  | [
      "interpolate-hcl",
      InterpolationSpecification,
      number | ExpressionSpecification,
      ...(number | ColorSpecification | ExpressionSpecification)[],
    ] // alternating number and ColorSpecificaton | ExpressionSpecification
  | [
      "interpolate-lab",
      InterpolationSpecification,
      number | ExpressionSpecification,
      ...(number | ColorSpecification | ExpressionSpecification)[],
    ] // alternating number and ColorSpecification | ExpressionSpecification
  | [
      "step",
      number | ExpressionSpecification,
      ExpressionInputType | ExpressionSpecification,
      ...(number | ExpressionInputType | ExpressionSpecification)[],
    ] // alternating number and ExpressionInputType | ExpressionSpecification
  // Variable binding
  | [
      "let",
      string,
...
export type VisibilitySpecification =
  | "visible"
  | "none"
  | ExpressionSpecification;
...
export type CompositeFunctionSpecification<T> =
  | {
      type: "exponential";
      stops: Array<[{ zoom: number; value: number }, T]>;
      property: string;
      default?: T;
    }
  | {
